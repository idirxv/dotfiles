...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"cpu 240 136"
		#"load 237 167"
		"mem_used terminal 255 default_separator no_sep_bg_color no_sep_fg_color no_spacing_disable separator_disable"
		"cpu_icon terminal 255 default_separator no_sep_bg_color no_sep_fg_color no_spacing_disable separator_disable"
		"lan_ip terminal 255 default_separator no_sep_bg_color no_sep_fg_color no_spacing_disable separator_disable"
		#"battery 137 127"
